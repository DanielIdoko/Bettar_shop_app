...
const HelpCenter = () => {
  return (
    <section className="help-center">
      <div className="w-fit h-full flex-1">
      ...
      <div className="w-fit h-full flex gap-3 items-center font-open-sans">
        {helpOptions.map((option) => (
          <div key={option.id} className="flex h-full items-center gap-3"> 
            {option.icon}
